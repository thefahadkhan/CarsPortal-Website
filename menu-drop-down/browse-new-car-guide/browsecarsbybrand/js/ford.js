document.addEventListener('DOMContentLoaded', function() {
    ...
    toyotaTabBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            toyotaTabContents.forEach(content => content.classList.remove('toyota-content-active'));
            ...
            document.getElementById(`toyotaTab${tabId}`).classList.add('toyota-content-active');
    ...
    function updateToyotaCardsDisplay() {
        const activeTab = document.querySelector('.toyota-tab-content.toyota-content-active');
        ...
        toyotaNextBtn.style.opacity = toyotaCurrentPage >= totalPages - 1 ? '0.3' : '1';
    }
